...
**Tabs++** is a minimalist, high-performance Chrome extension designed to make your browsing experience more persistent. It ensures that your **Pinned Tabs** and **Tab Groups** never stay closed accidentally.
...
- **Command Palette (`Ctrl+Shift+K`)**: A Spotlight-style search tool to quickly access open tabs, bookmarks, history, and perform quick searches using "bangs" (e.g. `!yt` for YouTube).
